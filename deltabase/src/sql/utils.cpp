...
std::string
sql::utils::to_string(sql::SqlTokenType type) {
    switch (type) {
...
std::string
sql::utils::to_string(sql::SqlKeyword type) {
...
std::string
sql::utils::to_string(sql::SqlOperator type) {
...
std::string
sql::utils::to_string(sql::SqlSymbol type) {
...
std::string
sql::utils::to_string(sql::SqlLiteral type, const std::string& value) {
    std::string literal;
