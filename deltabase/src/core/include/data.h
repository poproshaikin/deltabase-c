...
DataFilter *create_filter_condition(uuid_t column_id, FilterOp op, DataType type, const void *value);
DataFilter *create_filter_node(DataFilter *left, LogicOp op, DataFilter *right);
void free_filter(DataFilter *filter);
