...
// Basic operations
IndexNode*
create_index_node(bool is_leaf);
int
compare_index_keys(const IndexKey* left, const IndexKey* right);
uint64_t*
search_index(IndexNode* root, const IndexKey* key);
void
insert_into_index(IndexNode** root, const IndexKey* key, uint64_t row_id);
